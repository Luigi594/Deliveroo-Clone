...
const RestaurantScreen = () => {
  ...
  /** this will be used to grab all the details from an especific
   * restaurant, specially when we go to the basket screen
   */
  useEffect(() => {
      ...
      <ScrollView>
        <View className="relative pt-7">
          ...
          <TouchableOpacity
              ...
              className="absolute top-16 left-5 p-2 bg-gray-100 rounded-full">
